					...
					<div class="col-md-7">
						...
						<div class="billing-details">
							...
							<div class="form-group">
								<input class="input" type="text" name="slide_goods_name" required="required" placeholder="Product name" value="<?php if(isset($_POST['slide_goods_name'])){ echo $_POST['slide_goods_name'];} ?>">
							</div>
							...
							<div class="form-group">
								<input class="input" type="text" name="slide_price"  placeholder="Product price" value="<?php if(isset($_POST['slide_price'])){ echo $_POST['slide_price'];} ?>">
							</div>
							...
							<textarea class="form-control" name="description" id="description" placeholder="Enter description here"><?php if(isset($_POST['description'])){echo trim($_POST['description']);} ?></textarea> 
							</div>
