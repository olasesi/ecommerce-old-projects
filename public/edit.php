...
<?php
//if the number of slides is now 16 and you wish to add to it, it can be added but the list slide will be put into product category						
if (!isset($reg_errors_slider1)) {
	$reg_errors_slider1 = array();
}
	...
	<div class="col-md-5">
		...
		<div class="billing-details">
			<form method="POST" action="" enctype="multipart/form-data">
				...
				<?php
				if (array_key_exists('file_size1', $reg_errors_slider1)) {
					echo '<p class="message" style="color:red;">' . $reg_errors_slider1['file_size1'] . '</p>';
				}
				if (array_key_exists('wrong_upload1', $reg_errors_slider1)) {
					echo '<p class="message" style="color:red;">' . $reg_errors_slider1['wrong_upload1'] . '</p>';
				}
				...
				if (array_key_exists('not_moved1', $reg_errors_slider1)) {
					echo '<p class="message" style="color:red;">' . $reg_errors_slider1['not_moved1'] . '</p>';
				}
				?>
